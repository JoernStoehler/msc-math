...
(\texttt{viz\_\allowbreak export}) that writes polytope
skeleton and trajectory data as JSON, and a browser-based
viewer (\texttt{experiments/visualization/viz/}) using Three.js.
