...
for all~$\ell$. It remains to show that positive span is equivalent to the
conjunction: the normals span~$\mathbb{R}^4$ and all triples pass.
...
(Such strict inequalities exist: since the normals span~$\mathbb{R}^4$, $d$
cannot be orthogonal to all normals, so $S_0 \neq \{1, \ldots, F\}$.)
