...
remove such an orbit. Empty tubes contain no orbit and are discarded before
...
no-orbit outcome. Thus the implementation is intended to realize the corollary
on rational inputs satisfying both these input requirements and the regularity
...
way to distinguish predicates proved true, proved false, or left undecided.
It was retired and supplies no current flow-graph capacity evidence.
...
and rejection of unsupported inputs. These checks are falsification and correspondence
