...
python .agents/skills/paperorchestra-literature-review-agent/scripts/exa_search.py \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/pre_dedup_candidates.py \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/s2_cache.py \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/s2_search.py \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/s2_search.py --check-key
```
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/levenshtein_match.py \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/check_cutoff.py \
    --paper-year 2024 \
    --paper-month 9 \
    --cutoff 2024-10-01
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/dedupe_by_id.py \
    --in raw_pool.json \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/validate_pool.py \
...
python .agents/skills/paperorchestra-literature-review-agent/scripts/cross_verify.py \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/bibtex_format.py \
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/sync_keys.py \
    --pool workspace/citation_pool.json \
...
`../paperorchestra-paper-orchestra/references/anti-leakage-prompt.md`.
...
append §2 to `workspace/research_brief.md` (see `.agents/skills/paperorchestra-shared/research_brief_template.md`).
...
```bash
python .agents/skills/paperorchestra-literature-review-agent/scripts/citation_coverage.py \
    --tex workspace/drafts/intro_relwork.tex \
    --pool workspace/citation_pool.json
...
- `.agents/skills/paperorchestra-shared/research_brief_template.md` — **NEW** §2 schema; append after intro_relwork.tex is drafted
