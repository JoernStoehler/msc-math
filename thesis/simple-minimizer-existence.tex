...
%   HK2017 proof. Notation per correspondence.tex.
%
...
% FIXME(hbox): 1.62pt — long inline formula "$(\sigma_n, s_n, T_n, z_n(0)) \in S_F \times \Delta^{F-1} \times (0,\infty) \times \mathbb{R}^4$"; try \allowbreak after \times tokens or display the encoding on its own line
Each $z_n$ is encoded by
$(\sigma_n, s_n, T_n, z_n(0)) \in S_F \times \Delta^{F-1} \times (0,\infty) \times \mathbb{R}^4$,
