...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{pentagon_perturb_sys_hist.png}
...
\InputIfFileExists{pentagon_perturb_stats.tex}{}{%
  \InputIfFileExists{../exp-hko-local-maximum/perturbation-neighborhood/pentagon_perturb_stats.tex}{}{%
    \textbf{[pentagon\_perturb\_stats.tex not found]}%
  }%
}
...
%\input{pentagon_perturb_pca.tex}
