...
% Refines [prop:capacity-piecewise-smooth] from crates/exp-sys-landscape/sensitivity-analysis/math.tex
...
%   - Existing proposition: crates/exp-sys-landscape/sensitivity-analysis/math.tex
%
% Structure:
