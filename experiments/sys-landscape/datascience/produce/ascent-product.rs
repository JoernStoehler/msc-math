...
//!         experiments/sys-landscape/datascience/produce/ascent-product-endpoints.jsonl
...
//! `cargo run -p exp-sys-landscape --release --bin sys-dataset-ascent-product -- --out experiments/sys-landscape/datascience/produce/ascent-product-endpoints.jsonl --db-update`
//!
