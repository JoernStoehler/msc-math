...
% ====================================================================
% Relocated from exp-sys-optimization/sensitivity-analysis/math.tex
% (experiment deleted 2026-04-03, superseded by boundary-crossing-search).
% These lemmas document crates/library/src/derivatives.rs.
% Label sec:sys-optimization kept for backward compatibility with
% cross-references in gradient-is-zero/math.tex.
