//! Readable selected KKT-free capacity route for Lagrangian products.
//!
...
//!
//! Keep its mathematical semantics in sync with
//! `crates/symplectic/src/algorithms/capacity_4d/product.rs`. Intentional
//! differences are experiment counters and complete intermediate audits.
