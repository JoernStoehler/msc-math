...
- `.agents/`
  - `skills/`: Codex-native workflows and extra knowledge to read
- `.codex/`
  - `config.toml`
  - `agents/*.toml`: Codex-native subagents to call
  - `worktrees/`: local git worktrees for Codex sessions
- `feedback/*.md`: Incident reports; processed by Jörn
