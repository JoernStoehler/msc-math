...
For any other candidate~$(S', \sigma')$, $\beta'^\top H\, \beta' \leq V^*$
by maximality; hence $\max_{S,\sigma} \beta^\top H\, \beta = V^*$,
and the algorithm returns $(V^*)^{-1} = c_{\mathrm{EHZ}}(K)$.
\end{sloppypar}
\end{proof}
