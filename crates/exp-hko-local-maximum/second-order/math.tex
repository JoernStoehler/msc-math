...
\]
% [TODO: JÖRN - verify correct citation for capacity = min action over orbits.
% HK2017 Thm 1.4 gives c_EHZ via billiard orbits for Lagrangian products;
% the general polytope formulation (via KKT) is developed in our library.]
