---
name: paperorchestra-paper-orchestra
...
python .agents/skills/paperorchestra-paper-orchestra/scripts/check_idea_density.py \
...
python .agents/skills/paperorchestra-paper-orchestra/scripts/validate_consistency.py \
    --idea workspace/inputs/idea.md \
    --log workspace/inputs/experimental_log.md
```
...
```bash
python .agents/skills/paperorchestra-paper-orchestra/scripts/check_tex_packages.py \
...
Load `.agents/skills/paperorchestra-outline-agent/SKILL.md` and follow it. Output: `workspace/outline.json`.
Validate with `python .agents/skills/paperorchestra-outline-agent/scripts/validate_outline.py workspace/outline.json`.
...
- Sub-task B: load `.agents/skills/paperorchestra-literature-review-agent/SKILL.md`, execute the
...
```bash
python .agents/skills/paperorchestra-outline-agent/scripts/validate_outline.py workspace/outline_reconciled.json
python .agents/skills/paperorchestra-paper-orchestra/scripts/diff_outlines.py \
...
Load `.agents/skills/paperorchestra-section-writing-agent/SKILL.md` and follow it. This is **one
...
```bash
python .agents/skills/paperorchestra-section-writing-agent/scripts/orphan_cite_gate.py workspace/drafts/paper.tex workspace/refs.bib
python .agents/skills/paperorchestra-section-writing-agent/scripts/latex_sanity.py workspace/drafts/paper.tex
python .agents/skills/paperorchestra-paper-orchestra/scripts/anti_leakage_check.py workspace/drafts/paper.tex
python .agents/skills/paperorchestra-paper-orchestra/scripts/claim_evidence_gate.py \
...
Load `.agents/skills/paperorchestra-content-refinement-agent/SKILL.md` and follow it. The skill
...
- `.agents/skills/paperorchestra-shared/research_brief_template.md` — **NEW** schema for workspace/research_brief.md (accumulated cross-agent context)
