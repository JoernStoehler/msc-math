...
% crates/dev-gradient/numerics/math.tex
% to handle orbit appearance at feasibility boundaries.
%
% Sources:
%   - Generated data: crates/dev-gradient/numerics-subdifferential/*.jsonl
%   - Developer notes: crates/dev-gradient/numerics-subdifferential/logbook.md
%   - Supporting lemmas: crates/dev-gradient/numerics/math.tex
