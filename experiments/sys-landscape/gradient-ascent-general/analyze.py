...
Input: experiments/sys-landscape/gradient-ascent-general/data/*.jsonl (per-seed summaries).
...
def pick_jsonl_files() -> list[Path]:
    ...
    print(
        ...
        "See research/sys-landscape/design/gradient-ascent-general.md 'How to run'.",
        file=sys.stderr,
    )
    sys.exit(1)
