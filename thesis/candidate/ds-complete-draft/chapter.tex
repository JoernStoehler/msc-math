...
and incidences. With gradient-boosted regression trees and a common
training/test split, ridge-area features alone gave test $R^2=0.887$,
whereas combinatorial counts alone gave
...
maps. In a separate fresh pool, among products in the lowest one percent
by $R$, the half with lower $C$ had a mean advantage of $0.034$ over the other
