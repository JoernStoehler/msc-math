...
\end{itemize}
% [TODO: JÖRN - This section needs a characterization lemma: "a piecewise-affine
%   closed curve on bdry(K) is a simple Reeb orbit iff (checkable conditions)."
%   The four metrics above should map to those conditions. Subtlety: breakpoints
%   lie on faces (e.g. F_sigma(k) cap F_sigma(k+1)), not strictly at facet
%   transitions. The velocity condition holds by construction from (S, beta)
%   but the lemma should make this explicit.]
