...
//! Output Artifacts: experiments/hko-local-maximum/empirical/neighborhood-sampling/m10/pentagon-perturb.jsonl
//!
...
fn default_smoke_output_path() -> PathBuf {
    ...
    let dir = std::env::temp_dir().join(format!(
        "hko-neighborhood-m10-smoke-{}-{stamp}",
        std::process::id()
    ));
...
fn print_usage() {
    eprintln!(
        r#"Usage: hko-neighborhood-sampling m10 [options]
