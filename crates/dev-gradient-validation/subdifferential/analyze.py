...
Input:
  - crates/dev-gradient-validation/subdifferential/gradient-correctness-q5-subdiff.jsonl
  - crates/dev-gradient-validation/subdifferential/gradient-correctness-q5b-symmetric.jsonl
Output:
  - crates/dev-gradient-validation/subdifferential/gc_q5_convergence.png (Q5 subdiff vs single-orbit convergence)
  - crates/dev-gradient-validation/subdifferential/gc_q5_switching.png   (Q5 orbit switching rate vs t and gap)
  - crates/dev-gradient-validation/subdifferential/gc_q5b_boundary.png   (Q5b subdiff at exact switching boundaries)
"""
