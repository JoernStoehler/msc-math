...
| `M011` | supervised regression | feature-block regression with ridge and random forest | `ISLR-REG-RIDGE`, `ISLR-TREE-RF`, `ESL-SEL-RIDGE`, `ESL-TREE-RF` | tabular feature blocks over random and endpoint regimes | `experiments/sys-landscape/datascience/methods/feature-pattern-search/analyze.py`, `RESULTS.md`, `tasks/landscape.md` | `attempted` | `main-evidence` | Current repo summary treats the negative transfer result as claim-bearing. |
