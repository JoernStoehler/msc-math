...
| --- | --- | --- |
| HKO2024 local maximality | active: `experiments/hko-local-maximum/README.md`, `experiments/hko-local-maximum/theorem/README.md`, `experiments/hko-local-maximum/notes.md`; legacy redirects: `hko-local-maximum*.md` | `tasks/definition-of-success.md`, `tasks/current-state.md`, `tasks/planning-notes.md` |
...
| HKO local maximum | `experiments/hko-local-maximum/README.md`, `experiments/hko-local-maximum/theorem/README.md`, `experiments/hko-local-maximum/notes.md`; `hko-local-maximum*.md` are legacy redirects | local HKO status, theorem route, selected-branch breadcrumbs, and final wording gate |
