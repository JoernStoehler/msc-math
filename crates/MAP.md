...
| Euclidean polytopes target | flat functions over `Vector4<T>`; implemented first slice includes `origin_in_interior_of_conv_exact`, `polar_vertices_exact`, `polar_vertices_f64`, exact incidence, and f64 indeterminate tuple diagnostics | `crates/euclidean-polytopes/README.md`, `crates/euclidean-polytopes/DEVELOPMENT.md` |
