...
\begin{lemma}[Unique objective value]\label{lem:well-defined}
% [TODO: JÖRN - title changed from "Well-definedness" to fix 5.9pt overfull hbox.
%   Original title "Well-definedness" was approved at 06a976c. Re-verify title.]
