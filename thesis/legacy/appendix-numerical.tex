...
% appendix-numerical.tex was previously input by main.tex after \appendix.
%
...
%   Agent lookup: follows from Hofer-Zehnder (1994), Ch. 2, monotonicity axiom (A1).
%   No standalone theorem; derived via squeezing: K_n → K in Hausdorff implies (1-δ)K ⊂ K_n ⊂ (1+δ)K.
%   Explicit discussion: Cieliebak-Hofer-Latschev-Schlenk (2007), MSRI Publ. vol. 54.
%   Polytopes covered directly — no approximation argument needed.]
...
% [TODO: JÖRN - add \label{sec:random-sample} when random sample section is written]
(the random sweep experiment),
