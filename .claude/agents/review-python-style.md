...
<copied-from>CLAUDE.md § Experiments > Script conventions</copied-from>
...
**Dependencies:** Listed in `experiments/requirements.txt`. Use plain Python with standard data science libraries (numpy, pandas, matplotlib, scipy). No custom framework.
