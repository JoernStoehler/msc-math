...
%
% Sources: crates/dev-capacity-validation/correctness/run.rs (dataset generator + tests),
%   crates/dev-capacity-validation/correctness/correctness.jsonl (generated dataset),
%   crates/dev-capacity-validation/correctness/logbook.md (experiment design documentation).
%
% Structure:
%   - Algorithm variants table
%   - Verification capacity counts table
%   - Six test propositions (enumerated)
%   - Literature polytopes table
%
...
\begin{enumerate}
  ...
  \item \textbf{Continuity}: For the 10~polytopes from test~1, a small
    random perturbation of the dual vertices produces a small change in
    capacity.
...
\midrule
Simplex & 5 & 0.25 & 0.0417 & 0.750 & \cite{Nir2013} \\
Hypercube $[-1,1]^4$ & 8 & 4.0 & 16.0 & 0.500 & \cite{HK2019} Ex~4.6 \\
HK-O pentagon & 10 & 3.441 & 5.6532 & 1.047 & \cite{HaimKislevOstrover2024} Prop~1.4 \\
Lag.\ $\triangle \times \triangle$ & 6 & 1.5 & 1.6875 & 0.667 & \cite{HK2017} + billiard \\
Sym.\ $\triangle \times \triangle$ & 6 & 1.299 & 1.6875 & 0.500 & Prop.~\ref{prop:capacity-symplectic-product} \\
Lag.\ $\triangle \times \square$ & 7 & 1.5 & 1.2990 & 0.866 & \cite{HK2017} + billiard \\
Sym.\ $\triangle \times \square$ & 7 & 1.0 & 1.2990 & 0.385 & Prop.~\ref{prop:capacity-symplectic-product} \\
\bottomrule
\end{tabular}
