...
\begin{proof}
Standard calculus of variations for constrained problems in Sobolev spaces.
The Lagrange multiplier $\nu$ enforces the constraint $A(z) = T$, and the
constant $b$ arises from the translation invariance of $I_K$.
\end{proof}
