...
\cite{HaimKislevOstrover2024}: in their convention the second pentagon has
vertex angles \(-\pi/2+2\pi k/5\), and this rotation has
\(d(-\pi/2)=\pi/10\). The result below identifies the entire one-dimensional
profile of the systolic ratio in this family. In particular, it identifies the
HKO example, within this one-parameter family, as a global maximizer of the
rotated-pentagon profile.
