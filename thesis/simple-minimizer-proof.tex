...
For any $T > 0$, the space of closed, centered, simple
piecewise-Reeb curves with period~$T$ is compact
in~$W^{1,2}([0,T], \mathbb{R}^4)$.
The action~$A$ is continuous on this space,
and $I_K \equiv T$.
\end{lemma}
...
vanishing amount).
By Lemma~\ref{lem:compactness}, a subsequence
converges to a simple piecewise-Reeb curve~$z_*$
with $A(z_*) = T$ and $I_K(z_*) = T$.
