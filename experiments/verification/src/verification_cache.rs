//! Verification-package geometry cache.
//!
//! This is a local target-pool cache for validation binaries. It exists to
//! carry explicit dual vertices, vertices, incidence, and omega data loaded
//! from known fixtures and JSONL caches; capacity calls still receive the flat
//! fields directly.
...
#[derive(Clone)]
pub struct VerificationPolytopeCache {
...
impl VerificationPolytopeCache {
