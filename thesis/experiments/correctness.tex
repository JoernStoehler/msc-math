...
%
% Sources: crates/datasets/src/bin/correctness.rs (dataset generator + tests),
%   experiments/data/correctness.jsonl (generated dataset),
%   experiments/correctness.md (experiment design documentation).
%
