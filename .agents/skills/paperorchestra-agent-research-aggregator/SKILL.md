...
```bash
python .agents/skills/paperorchestra-agent-research-aggregator/scripts/extract_experiments.py \
...
```bash
python .agents/skills/paperorchestra-agent-research-aggregator/scripts/format_po_inputs.py \
