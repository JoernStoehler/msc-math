% formal/capacity-smoothness-classification.tex — basic gradient validation (Q1 generic, Q2 non-generic)
%
% Smoothness analysis of the EHZ capacity as a function of dual vertices.
% Refines [prop:capacity-piecewise-smooth] from formal/capacity-derivatives.tex
% with per-orbit feasibility analysis and precise smoothness classification.
%
% Sources:
%   - Historical empirical origin: old gradient-validation artifacts, removed
%     in the numerics replacement; use git history if needed.
%   - KKT formulation: formal/ehz-kkt-system.tex
%   - Existing proposition: formal/capacity-derivatives.tex
%
% Structure:
...
the KKT system (see \texttt{formal/ehz-kkt-system.tex}) is
