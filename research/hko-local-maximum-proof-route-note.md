...
`experiments/hko-local-maximum/active-branch-diagnostic/smoke-active-branch-diagnostic.json`.
...
1. `research/hko-local-maximum-exact-clarke.md` records that the seven-facet
   ...
   minimizing family.
2. `experiments/hko-local-maximum/exact-clarke/segment-gradient-reduction.json`
...
The Rust diagnostic
`experiments/hko-local-maximum/active-branch-diagnostic/main.rs` now records a
