...
AI therefore affected both the mathematical artifacts produced and the
feasible research loop: more proposals could be made executable, criticized,
and abandoned, and one bounded source-rich episode produced substantive new
proof reasoning.  The record does not reduce this heterogeneous work to one
capability or productivity score.  It instead shows why production,
verification, interpretation, and integration must remain distinct.
