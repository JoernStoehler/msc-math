...
| Block | Metadata R^2 | Combined R^2 | Delta R^2 | Residual R^2 | Metadata RMSE | Combined RMSE | Adds signal? |
|-------|-------------|--------------|-----------|--------------|---------------|---------------|-------------|
| `geometry` | -0.0079 | -0.2202 | -0.2123 | -0.2107 | 0.1218 | 0.1340 | no |
| `face_geometry` | -0.0079 | 0.0245 | 0.0324 | 0.0321 | 0.1218 | 0.1198 | yes |
| `face_symplectic` | -0.0079 | 0.2574 | 0.2653 | 0.2632 | 0.1218 | 0.1045 | yes |
| `skeleton` | -0.0079 | -0.6254 | -0.6175 | -0.6126 | 0.1218 | 0.1547 | no |
| `omega` | -0.0079 | -0.2081 | -0.2002 | -0.1986 | 0.1218 | 0.1333 | no |
| `orbit` | -0.0079 | 0.1279 | 0.1358 | 0.1348 | 0.1218 | 0.1133 | yes |
| `trajectory` | -0.0079 | 0.0063 | 0.0142 | 0.0141 | 0.1218 | 0.1209 | yes |
| `all_non_metadata` | -0.0079 | 0.3281 | 0.3360 | 0.3334 | 0.1218 | 0.0994 | yes |
