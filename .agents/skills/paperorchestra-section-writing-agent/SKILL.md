---
name: paperorchestra-section-writing-agent
...
```bash
python .agents/skills/paperorchestra-section-writing-agent/scripts/extract_metrics.py \
...
python .agents/skills/paperorchestra-section-writing-agent/scripts/latex_sanity.py \
    workspace/drafts/paper.tex

# Anti-leakage post-check: no author names, emails, affiliations
python .agents/skills/paperorchestra-paper-orchestra/scripts/anti_leakage_check.py \
    workspace/drafts/paper.tex
```
