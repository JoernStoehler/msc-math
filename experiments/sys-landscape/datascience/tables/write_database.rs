...
use crate::rows::{ComputedPolytopeTableRow, PolytopeTableRow, ProvenanceRunRow};
use serde::Serialize;
use std::fs::File;
...
pub fn write_database(
    ...
    computed_polytope_rows: &[ComputedPolytopeTableRow],
) {
    ...
    write_jsonl(
        &out_dir.join("computed-polytope-table.jsonl"),
