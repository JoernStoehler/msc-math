...
| `crates/euclidean-polytopes/` | ordinary convex-polytope geometry in ambient `R^4`; currently owns exact origin-interior, exact extreme-point, exact polar vertex enumeration, diagnostic `f64` polar enumeration, full-dimensional `f64` volume from recovered or known incidence, and incidence-only 2-face ordering inside volume decomposition | `crates/euclidean-polytopes/README.md`, `crates/euclidean-polytopes/DEVELOPMENT.md`, `tasks/euclidean-polytopes.md` |
