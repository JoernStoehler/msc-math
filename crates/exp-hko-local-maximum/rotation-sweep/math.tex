...
%
% Sources:
%   - Generated data: crates/exp-hko-local-maximum/rotation-sweep/lagrangian-products-5x5.jsonl
%     and crates/exp-hko-local-maximum/rotation-sweep/lagrangian-products-<n>x<m>-6deg.jsonl
...
% [TODO: JÖRN - add cross-reference to the random-product-sweep experiment once written up]
