...
See `.agents/skills/paperorchestra-outline-agent/references/outline-schema.md` and the JSON Schema at
`.agents/skills/paperorchestra-outline-agent/references/outline_schema.json`.
