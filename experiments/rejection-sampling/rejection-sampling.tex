...
Figure~\ref{fig:acceptance-rates} visualizes these trends.

\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth]{../experiments/rejection-sampling/acceptance_rates.png}
\caption{Acceptance rates by facet count for three height ranges.
  Narrow heights ($h \in [0.8, 1.2]$) give the highest acceptance at
  large~$F$; wide heights ($h \in [0.1, 5.0]$) are penalized by
  irredundancy failures.}
