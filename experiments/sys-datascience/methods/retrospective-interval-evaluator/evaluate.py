...
def main():
    ...
    with args.input.open() as source, args.output.open('x') as out:
        for line_number, raw in enumerate(source,1):
            ...
            row = {'schema':'retrospective-capacity-interval-v1','line_number':line_number,'input_raw':raw,
                   'input_line_sha256':hashlib.sha256(raw.encode()).hexdigest(), 'evaluator':identity,
                   'capacity_method':'production-capacity-interval-v1','optional_scalar_relative_tolerance':1e-10,
