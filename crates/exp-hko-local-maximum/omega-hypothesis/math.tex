...
%
% Sources:
%   - Generated data: crates/exp-hko-local-maximum/omega-hypothesis/omega-obstacle.jsonl
%   - Plot script: crates/exp-hko-local-maximum/omega-hypothesis/analyze.py
%   - Experiment notes: crates/exp-hko-local-maximum/omega-hypothesis/logbook.md
%
% Structure:
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{omega_obstacle_ridge_min_vs_sys.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{omega_obstacle_orbit_vs_nonorbit.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{omega_obstacle_gradient_dots.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{omega_obstacle_omega_vs_dot.png}
