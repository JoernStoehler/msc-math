...
Input: crates/exp-baseline-characterization/random-sweep/random-sweep.jsonl
Output: crates/exp-baseline-characterization/random-sweep/random_sweep_sys_vs_f.png
"""
