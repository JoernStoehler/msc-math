...
Input: crates/exp-algorithm-comparison/ablation/ablation.jsonl (generated by ablation.rs)
Output: crates/exp-algorithm-comparison/ablation/ablation_timing.png (timing comparison figure)
"""
