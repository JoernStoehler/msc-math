...
pub fn compute_face_symplectic_fields(
    ...
    for two_face in two_faces {
        ...
        ridge_symp_areas.push(symp_area);
        ridge_euclidean_areas.push(euclidean_area);
    ...
    let (
        ...
        ridge_euclidean_area_std,
        ridge_euclidean_area_min,
        ridge_euclidean_area_max,
    ...
    FaceSymplecticFields {
        ...
        ridge_euclidean_area_min,
        ridge_euclidean_area_max,
        ridge_euclidean_area_q25: quantile_or_zero(&ridge_euclidean_areas, 0.25),
        ridge_euclidean_area_median: quantile_or_zero(&ridge_euclidean_areas, 0.50),
        ridge_euclidean_area_q75: quantile_or_zero(&ridge_euclidean_areas, 0.75),
        ridge_euclidean_area_q90: quantile_or_zero(&ridge_euclidean_areas, 0.90),
        ridge_euclidean_area_q95: quantile_or_zero(&ridge_euclidean_areas, 0.95),
        ridge_euclidean_area_sum: ridge_euclidean_areas.iter().sum::<f64>(),
        ridge_euclidean_area_max_share: max_share(&ridge_euclidean_areas),
        ridge_euclidean_area_top3_share: top_k_share(&ridge_euclidean_areas, 3),
        ridge_euclidean_area_zero_fraction: fraction_at_most(&ridge_euclidean_areas, 1e-12),
        ridge_euclidean_area_le_1em3_fraction: fraction_at_most(&ridge_euclidean_areas, 1e-3),
        ridge_euclidean_area_le_1em2_fraction: fraction_at_most(&ridge_euclidean_areas, 1e-2),
        ridge_euclidean_area_le_1em1_fraction: fraction_at_most(&ridge_euclidean_areas, 1e-1),
        ridge_symp_over_euclidean_area_mean,
        ridge_symp_over_euclidean_area_std,
        ridge_symp_over_euclidean_area_min,
        ridge_symp_over_euclidean_area_max,
