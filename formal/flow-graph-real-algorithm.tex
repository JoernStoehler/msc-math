...
The Rust action-cutoff optimization, arbitrary bounded-irredundant input
validation, Rust correspondence, and f64 analysis are separate implementation
and numerical-analysis obligations.
\end{remark}
