...
%
% Sources:
%   - Generated data: crates/exp-hko-local-maximum/gradient-analysis/hko-neighborhood-sensitivity.jsonl
%   - Plot script: crates/exp-hko-local-maximum/gradient-analysis/analyze.py
