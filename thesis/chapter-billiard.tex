% chapter-billiard.tex — \input'd from main.tex
% Sources: Bezdek-Bezdek (2009), Rudolf (2022), Artstein-Avidan & Ostrover (2014),
%   HK2017. Agent-written; all proofs require Joern's verification.
%
% Structure:
%   6.1 Lagrangian products
%   6.2 Structure of simple orbits on Lagrangian products
%   6.3 Billiard characterization and bounce bound
%   6.4 Billiard algorithm

\section{EHZ Capacity of Lagrangian Products}\label{sec:billiard}

% [TODO: JOERN - verify all proofs in this section. Agent-written throughout.
%   The sigma structure lemma was discussed in chat and the statement confirmed,
%   but the written proof needs verification.]

%%% ---------------------------------------------------------------
\subsection{Lagrangian Products}\label{subsec:lagrangian-products}
%%% ---------------------------------------------------------------
...
%%% ---------------------------------------------------------------
\subsection{Structure of Simple Orbits}\label{subsec:orbit-structure}
%%% ---------------------------------------------------------------
...
% [TODO: JOERN - verify this proof. Statement confirmed in chat,
%   proof needs checking.]
...
%%% ---------------------------------------------------------------
\subsection{Billiard Characterization and Bounce Bound}%
\label{subsec:bounce-bound}
%%% ---------------------------------------------------------------

% [TODO: JOERN - verify the citation chain. Agent extracted these from
%   papers/hko2024/counterexample.tex and archaeology docs. Check that
%   the theorem statements are cited correctly.]
...
\textup{(Bezdek \& Bezdek~\cite{BezdekBezdek2009};
Rudolf~\cite{Rudolf2022}.)}
...
%%% ---------------------------------------------------------------
\subsection{The Billiard Algorithm}\label{subsec:billiard-algorithm}
%%% ---------------------------------------------------------------

\begin{theorem}[Completeness of the billiard enumeration]%
\label{thm:billiard-completeness}
% [TODO: JOERN - verify this proof carefully. It combines three
%   external results. The key claim is that the simple minimizer
%   has alternating block structure with k <= 3.]
Let $K = K_q \times K_p$ be a Lagrangian product.
...
% [GAP - AGENT CONFIDENCE 80%: Step 2 implicitly uses that the
%   number of q-blocks in the simple minimizer equals the number
%   of bounce points in the billiard trajectory achieving the same
%   action. This follows from the Reeb-orbit-to-billiard correspondence
%   (Rudolf 2022), but the details of the correspondence for
%   non-smooth K_p (polygonal) may need care.
%   JOERN: verify this step connects correctly.]
