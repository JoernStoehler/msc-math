...
\subsection{Random Lagrangian Product Sample}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{random_product_sweep_sys_vs_pair.png}
...
(Section~\ref{sec:random-sample}, maximum~$\mathrm{sys} = 0.58$),
