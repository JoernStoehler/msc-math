...
```bash
python .agents/skills/paperorchestra-section-writing-agent/scripts/orphan_cite_gate.py \
...
# 3. structural sanity
python .agents/skills/paperorchestra-section-writing-agent/scripts/latex_sanity.py paper.tex || REVERT
python .agents/skills/paperorchestra-section-writing-agent/scripts/orphan_cite_gate.py paper.tex ../../refs.bib || REVERT

# 4. anti-leakage
python .agents/skills/paperorchestra-paper-orchestra/scripts/anti_leakage_check.py paper.tex || REVERT
