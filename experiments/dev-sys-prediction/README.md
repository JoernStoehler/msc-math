...
hydrated and `/tmp/dev-gradient-ascent-branch-diagnostic-allsafe-check` has
already been generated by the gradient-ascent branch diagnostic. This exact
larger run is a scratch reproduction recipe, not a fresh-checkout durable
packet.
