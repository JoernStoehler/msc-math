...
% Refines [prop:capacity-piecewise-smooth] from crates/exp-sys-optimization/sensitivity-analysis/math.tex
% with per-orbit feasibility analysis and precise smoothness classification.
%
% Sources:
%   - Generated data: crates/exp-sys-optimization/gradient-validation/*.jsonl
%   - Developer notes: crates/exp-sys-optimization/gradient-validation/logbook.md
%   - KKT formulation: crates/library/src/kkt/math.tex
%   - Existing proposition: crates/exp-sys-optimization/sensitivity-analysis/math.tex
%
% Structure:
...
the KKT system (see \texttt{crates/library/src/kkt/math.tex}) is
