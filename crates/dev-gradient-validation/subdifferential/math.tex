% math.tex — subdifferential prediction (Q5 orbit-switching, Q5b exact boundaries)
%
% Extends [prop:capacity-smoothness-classification](b) from
% crates/dev-gradient-validation/basic-validation/math.tex
% to handle orbit appearance at feasibility boundaries.
%
% Sources:
%   - Generated data: crates/dev-gradient-validation/subdifferential/*.jsonl
%   - Developer notes: crates/dev-gradient-validation/subdifferential/logbook.md
%   - Supporting lemmas: crates/dev-gradient-validation/basic-validation/math.tex
