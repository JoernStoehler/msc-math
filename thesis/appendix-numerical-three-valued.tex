...
\item[Maximum tracking] (``find the largest admissible $Q$''):
  ...
  inadmissible and discarded; uncertain candidates at or
  below the certified value are irrelevant (the certified
  value already dominates).
  Downstream consumers
  (Section~\ref{app:error-tracking}) decide how to handle
  the remaining uncertainty---e.g.\ accept the certified
  lower bound, or attempt more expensive tests to resolve
