...
The 4D crosspolytope~$K = \operatorname{conv}\{\pm e_1, \pm e_2,
...
% Jörn: math approved (pending commit) — from \subsubsection{Symmetry reduction} to end of symmetry argument
