...
\begin{align*}
  ...
  \quad\text{a.e.}
\end{align*}
Thus $\gamma$ is a primal critical point (Hamiltonian orbit on $\partial K$).
...
Since the forward and reverse directions establish a correspondence between
primal and dual critical points via symmetry classes, and since
primal critical points $\gamma$ and dual critical points $z$ in the same
symmetry class have $A(\gamma) = I_K(z)$ (both equal the period),
