...
agree. The remaining input is the existence part of Clarke's dual action
principle: the constrained dual infimum is attained, and a dual minimizer is a
weak critical point. This is the variational statement recorded in the
nonsmooth dual-action setup used by Haim--Kislev
\cite[Section~2]{HK2017}. Hence the dual minimum is attained among the dual
critical points just considered, and the primal and dual minima agree.
\end{proof}
