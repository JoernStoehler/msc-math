...
\item \emph{Solve step.}
  ...
  $\hat x = \sum_j (v_j^\top b / \lambda_j)\, v_j$
  satisfies
  \[
    \frac{\|\hat x - x\|}{\|x\|}
...
The error tracking happens after the eigendecomposition step
and does not require modifying the eigendecomposition itself.
\end{remark}
