...
| Euclidean polytopes | migration plan for ordinary convex-polytope geometry currently entangled with symplectic code; first exact polar slice is implemented in `crates/euclidean-polytopes/` | `tasks/euclidean-polytopes.md` |
