...
%
% Sources:
%   - Generated data: crates/exp-hko-local-maximum/gradient-is-zero/hko-neighborhood-sensitivity.jsonl
%   - Plot script: crates/exp-hko-local-maximum/gradient-is-zero/analyze.py
