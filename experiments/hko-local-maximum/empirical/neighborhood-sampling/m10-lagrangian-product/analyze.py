...
Input Artifacts: experiments/hko-local-maximum/empirical/neighborhood-sampling/m10-lagrangian-product/lagrangian-search.jsonl (per-sample data)
       experiments/hko-local-maximum/empirical/neighborhood-sampling/m10-lagrangian-product/lagrangian-search-levels.jsonl (per-level summary)
Output Artifacts: experiments/hko-local-maximum/empirical/neighborhood-sampling/m10-lagrangian-product/lagrangian_search_fraction.png (fraction sys>1 vs epsilon)
        experiments/hko-local-maximum/empirical/neighborhood-sampling/m10-lagrangian-product/lagrangian_search_sys_vs_eps.png (sys distribution per epsilon)
        experiments/hko-local-maximum/empirical/neighborhood-sampling/m10-lagrangian-product/lagrangian_probe_radii.png (probe radius scatter)
"""
