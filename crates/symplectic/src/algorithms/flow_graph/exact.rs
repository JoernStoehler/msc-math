...
fn resolve_closed_word_exact_with_action_cutoff(
    input: &ExactFlatTubeInput<'_>,
    sigma: &[usize],
    action_cutoff: Option<&BigRational>,
) -> Result<(ExactClosedWordResult, ExactClosedTubeMetrics), ExactClosedTubeError> {
...
fn validate_exact_input(input: &ExactFlatTubeInput<'_>) -> Result<(), ExactClosedTubeError> {
...
mod tests {
    ...
    fn exact_search_rejects_invalid_input_shape() {
        ...
        let facet_intersection_is_nonempty = DMatrix::from_element(2, 3, true);
