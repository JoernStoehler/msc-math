...
%
% Sources:
%   - Generated data: crates/exp-sys-optimization/large-scale-descent/gradient-descent.jsonl
%   - Plot script: crates/exp-sys-optimization/large-scale-descent/analyze.py
%   - Developer notes: crates/exp-sys-optimization/large-scale-descent/logbook.md
...
\begin{figure}[htbp]
\centering
\includegraphics{gradient_descent_scatter.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{gradient_descent_gradient.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{gradient_descent_stepsize.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{gradient_descent_survival.png}
