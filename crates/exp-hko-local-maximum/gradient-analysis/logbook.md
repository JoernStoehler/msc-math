...
Split from `gradient-is-zero/logbook.md` (Phase A content). See `gradient-is-zero/logbook.md` for full history including motivation, interpretation, and theoretical framework.
