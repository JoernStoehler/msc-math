...
logarithmic sensitivity $\partial\,\mathrm{sys}/\partial\log h_k
= h_k \cdot \partial\,\mathrm{sys}/\partial h_k$ across all polytopes and facets.
The logarithmic derivative is the natural quantity: it measures the response
of $\mathrm{sys}$ to a relative (scale-invariant) change in facet height.
