# Trace Thesis Content And Support

Use this reference when a task must connect intended thesis content, candidate
prose, and repository evidence. Choose the traversal from the downstream
decision; do not perform every traversal by default.

## Substantiate Candidate Prose
...
scope and source surface, not a proof that every valuable repo fact was found.
...
support/status decision can be made; do not turn ordinary authoring into
