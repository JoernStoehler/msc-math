...
% 2026-06-22 Codex checked the displayed determinant values by an exact
% rational scratch implementation of the primitive linear maps.
\[
...
primitive-denominator domain; this corollary does not assert density inside
the space of valid irredundant facet presentations.
\end{corollary}
