...
%
% Sources:
%   - Generated data: crates/exp-baseline-characterization/random-sweep/random-sweep.jsonl
%   - Plot script: crates/exp-baseline-characterization/random-sweep/analyze.py
%   - Logbook: crates/exp-baseline-characterization/random-sweep/logbook.md
%
% Structure:
%   - Sampling setup
