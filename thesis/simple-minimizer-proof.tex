...
Since $I_K$ and $A$ are 2-homogeneous in velocity and $I_K$ is translation-invariant,
the Euler-Lagrange equation for $I_K - \lambda A$ is invariant under
$z(t) \mapsto \alpha z(t/\alpha^2) + b$, so $z'$ is a critical point.
By 2-homogeneity, $A(z') = \alpha^2 A(z) = \alpha^2 T = T'$ and
$I_K(z') = I_K(z)$ (using translation-invariance and the substitution $s = t/\alpha^2$).
\end{proof}
