...
%
% Sources: crates/exp-capacity-axioms/correctness/run.rs (dataset generator + tests),
%   crates/exp-capacity-axioms/correctness/correctness.jsonl (generated dataset),
%   crates/exp-capacity-axioms/correctness/logbook.md (experiment design documentation).
%
% Structure:
