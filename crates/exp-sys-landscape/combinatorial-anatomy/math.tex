% math.tex — combinatorial-anatomy experiment
%
...
% Also contains the gradient formula used by both anatomy and sweep experiments.
%
% Sources:
%   - run.rs: compute_step_bound_detailed(), compute_sys_gradient_a()
%   - logbook.md: empirical continuity observation
%   - crates/library/src/kkt/math.tex: transition feasibility [lem:numerical-transition-feasibility]
%   - crates/library/src/geom/math.tex: EHZ capacity [def:ehz-capacity], systolic ratio [def:systolic-ratio]
...
% [TODO: JÖRN - review the polytope-specific mechanism below and decide whether
% the direct argument or the citation of general c_EHZ continuity is better for
% the thesis. The direct argument gives lower semicontinuity; full continuity
% may require the general theory.]
...
% [TODO: JÖRN - verify this citation. The continuity result is standard but
% I haven't checked the exact statement in Hofer--Zehnder. The extension to
% non-smooth bodies (polytopes) may need the approximation argument from
% the definition of c_EHZ.]
