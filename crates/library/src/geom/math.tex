...
%   Note: code/math.tex must NOT reference thesis/ files (convention).
...
% Source: check_bounded_f64_first in vertex_enumeration.rs
...
% [TODO: JÖRN - verify statement and proof]
% Source: enumerate_vertices_int in vertex_enumeration.rs
...
% [TODO: JÖRN - verify statement and proof]
% Source: check_irredundancy_f64_first in vertex_enumeration.rs
...
% [TODO: JÖRN - verify statement and proof]
% Source: optimized vertex enumeration in vertex_enumeration.rs
...
% [TODO: JÖRN - verify exact theorem number. Was "Higham Ch. 5" but Ch. 5 = Polynomials.
%   SVD backward stability: Higham Ch. 19 (QR/SVD algorithms) or GVL (2013) §8.6.]
\begin{unverified}
...
% [TODO: JÖRN - verify exact section numbers. Was "Higham Ch. 3, 5" but Ch. 5 = Polynomials.
%   Triangular solve backward error: Higham Thm. 8.5; SVD: GVL §8.6 or Higham Ch. 19.]
\begin{unverified}
...
% [TODO: JÖRN - verify exact corollary number. GVL Ch. 8 is correct (§8.1 has Weyl eigenvalue thm).
%   The singular value version follows via the augmented matrix. Exact corollary number not confirmed.]
\begin{unverified}
\begin{fact}[Weyl's singular value perturbation theorem;
  {Golub \& Van~Loan~(2013), \S8.1}]\label{fact:prefilter-weyl}
For any $B, B' \in \mathbb{R}^{n \times n}$:
$|\sigma_i(B) - \sigma_i(B')| \le \|B - B'\|$.
\end{fact}
\end{unverified}

% [TODO: JÖRN - verify exact lemma number. Was "Higham Ch. 2" but Ch. 2 = Floating Point Arithmetic.
%   Banach perturbation lemma: Higham Ch. 7, §7.4 (The Matrix Inverse).]
\begin{unverified}
...
%   Higham (2002) Ch. 5. This is tracked in TASKS.md under
