...
//! Output Artifacts: experiments/hko-local-maximum/empirical/neighborhood-sampling/m10-lagrangian-product/lagrangian-probe.jsonl
//!
//! Architecture:
//! 1. `cargo run -p exp-hko-local-maximum --release --bin hko-neighborhood-sampling -- m10-lagrangian-product-probe --smoke`
//!    runs one-direction smoke mode.
//! 2. `cargo run -p exp-hko-local-maximum --release --bin hko-neighborhood-sampling -- m10-lagrangian-product-probe`
//!    generates the full dataset.
//! 3. Writes to m10-lagrangian-product/lagrangian-probe*.jsonl
...
fn print_usage() {
    eprintln!(
        r#"Usage: hko-neighborhood-sampling m10-lagrangian-product-probe [options]
