...
By Lemma~\ref{lem:shoelace}, the action is a sum of
pairwise terms $|I_i|\,|I_j|\,\omega_0(w_i, w_j)$
...
In the original ordering, these cross-terms contribute
$\sum_{i \in M}
  |I_i|\,(|I_r| - |I_s|)\, \omega_0(w_i, v)$;
in the merged ordering, they contribute
$\sum_{i \in M} |I_i|\,(|I_r| + |I_s|)\, \omega_0(w_i, v)$.
Writing $S = \sum_{i \in M} |I_i|\, \omega_0(w_i, v)$
for the weighted symplectic interaction between
the middle segments and the repeated velocity~$v$,
