...
pentagon products satisfy an exact inverse-square relation, while rotated
equilateral-triangle products have the same strict ordering by both
quantities. A broader account must accommodate these opposite family
laws. For search, direct ratio evaluations and local branch models can
guide improvement beyond what geometric selection alone establishes.
