...
MANIFEST="${2:-experiments/dev-quadratic-program/verification/manifest.json}"
...
python3 experiments/dev-quadratic-program/performance/scripts/summarize_phase_jsonl.py "$OUT_DIR" \
