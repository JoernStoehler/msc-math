---
name: paperorchestra-outline-agent
...
7. **Validate**:
   ```bash
   python .agents/skills/paperorchestra-outline-agent/scripts/validate_outline.py workspace/outline.json
   ```
...
8. **Append §1 to research_brief.md** (see `.agents/skills/paperorchestra-shared/research_brief_template.md`):
...
- `.agents/skills/paperorchestra-shared/research_brief_template.md` — **NEW** §1 schema; append after outline.json passes validation
