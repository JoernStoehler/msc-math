...
Then:
\begin{enumerate}[(a)]
\item $z_{\alpha,b}$ is closed and is a critical point of the dual problem.
\item $I_K(z_{\alpha,b}) = I_K(z)$ (independent of $\alpha$ and $b$).
\item The action scales as $A(z_{\alpha,b}) = \alpha^2\, A(z)$.
\item If $A(z) = T_z$, then $A(z_{\alpha,b}) = T_{\alpha,b}$
