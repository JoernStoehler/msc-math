...
%   - library/src/kkt/math.tex: transition feasibility [lem:numerical-transition-feasibility]
%   - library/src/geom/math.tex: EHZ capacity [def:ehz-capacity], systolic ratio [def:systolic-ratio]
