...
The later computer-assisted proofs use these results in two ways.
The HKO local-maximum proof uses selected active words to build smooth upper
bounds. The rotated-pentagon proof uses the specialized
...
Section~\ref{sec:numerics} describes those checks. The HKO and rotated-pentagon
proofs use separate SageMath programs over the relevant number fields.
