#!/usr/bin/env python3
"""
Verify the widened exact representative-row witness in SageMath.
...
Input Artifacts: experiments/hko-local-maximum/history/exact-witness/widened-representative-witness.json
Output Artifacts: experiments/hko-local-maximum/history/exact-witness/widened-representative-witness-verification.json
"""
