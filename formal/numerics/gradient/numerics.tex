% formal/numerics/gradient/numerics.tex — basic gradient validation (Q1 generic, Q2 non-generic)
%
% Smoothness analysis of the EHZ capacity as a function of dual vertices.
% Refines [prop:capacity-piecewise-smooth] from formal/library/algorithms.tex
...
%   - KKT formulation: formal/library/kkt.tex
%   - Existing proposition: formal/library/algorithms.tex
%
% Structure:
...
the KKT system (see \texttt{formal/library/kkt.tex}) is
