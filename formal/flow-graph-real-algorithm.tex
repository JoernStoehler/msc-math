...
not analyze f64 rounding.  The correctness theorem uses the nonempty
facet-pair nonzero-\(\omega_0\) condition from
Definition~\ref{def:fg-nondegenerate-facet-presentation}.  This matches the
current exact Rust rejection boundary and is stronger than the local
physical-transition condition needed in the proof of
