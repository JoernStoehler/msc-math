...
This file is a maintainer-facing entry point, not a process contract or thesis
source.
...
The former long design-session questionnaire and scaffold-conversion process
notes were removed after their reusable process knowledge moved into the
`$thesis` skill. Git history preserves that dated discussion when a focused
provenance question makes it relevant.
