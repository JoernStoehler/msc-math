...
- **Empirical performance** (from experiments/numerics/error-bounds/algorithm-notes.md, 44,808 natural polytope σ-nodes):
...
### Empirical validation summary (from experiments/numerics/error-bounds/algorithm-notes.md)
