...
Goal: freeze the current Packet 3 widened representative surface into one self-contained
      ...
      both consume.
Input Artifacts: experiments/hko-local-maximum/history/exact-witness/hko-geometry.json
                 ...
                 experiments/hko-local-maximum/history/exact-witness/endpoint-representative-rows.json
                 experiments/hko-local-maximum/history/exact-witness/midpoint-representative-rows.json
Output Artifacts: experiments/hko-local-maximum/history/exact-witness/widened-representative-witness.json
"""
