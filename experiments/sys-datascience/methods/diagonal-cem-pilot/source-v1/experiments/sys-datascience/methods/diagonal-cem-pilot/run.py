...
def main():
    paths=[P/'Cargo.toml',P/'Cargo.lock',P/'src/main.rs',P/'run.py',P/'analyze.py',
           * (P.parent/'equal-budget-product-search/src').glob('*.rs'),P.parent/'equal-budget-product-search/Cargo.toml',
           ROOT/'crates/symplectic/src/geom/polygon.rs',TARGET/'diagonal-cem-pilot']
    frozen={'schema':'diagonal-cem-pilot-v1','seeds':SEEDS,'population':64,'elites':16,'generations_including_initial':4,
            ...
            'per_input_seconds':5,'outer_wall_seconds':180,'no_update_on_incomplete_generation':True,
