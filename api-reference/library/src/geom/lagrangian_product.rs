...
// Source: crates/library/src/geom/lagrangian_product.rs
...
///
/// Mathematical correspondence: [def:lagrangian-product]
pub fn lagrangian_product(q_normals: &[Vector2<f64>], q_heights: &[f64], p_normals: &[Vector2<f64>], p_heights: &[f64]) -> Result<Polytope4D, ConstructionError> { ... }
