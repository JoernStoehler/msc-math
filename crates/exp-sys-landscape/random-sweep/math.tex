...
%
% Sources:
%   - Generated data: crates/exp-sys-landscape/random-sweep/random-sweep.jsonl
%   - Plot script: crates/exp-sys-landscape/random-sweep/analyze.py
%   - Logbook: crates/exp-sys-landscape/random-sweep/logbook.md
%
% Structure:
%   - Sampling setup
