...
| Codex capability | project-local capability evidence, failure modes, and planning controls for assigning work to GPT-5.5/Codex agents | `.agents/skills/codex-capability/references/codex-capability-register.md` |
