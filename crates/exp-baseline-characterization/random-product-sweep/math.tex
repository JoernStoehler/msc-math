...
%
% Sources:
%   - Generated data: crates/exp-baseline-characterization/random-product-sweep/random-product-sweep.jsonl
%   - Plot script: crates/exp-baseline-characterization/random-product-sweep/analyze.py
%   - Experiment notes: crates/exp-baseline-characterization/random-product-sweep/logbook.md
%
% Structure:
%   - Sampling setup
%   - Summary plot
