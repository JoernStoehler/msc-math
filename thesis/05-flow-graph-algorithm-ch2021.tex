...
fixed equation, or one whose fixed set misses the tube, is instead an exact
no-orbit outcome.  Thus the Rust wrapper is
...
On selected deterministic rational F5, F6, and F7 cases, exact flow-graph
search agrees with the certified Haim--Kislev/QP scalar aggregate. These
comparisons, the retained exact words, and the targeted resolver tests are
