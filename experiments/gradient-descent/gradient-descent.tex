...
\caption{Convergence diagnostics.
  ...
  final $\mathrm{sys}$; higher final $\mathrm{sys}$ correlates with
  larger residual gradients ($r \approx 0.80$).
  Center: median step size (with IQR band) drops by 2--3 orders of
  magnitude over the first 10~iterations.
