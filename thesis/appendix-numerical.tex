...
(Lemma~\ref{lem:q-interval}): even though the
...
Lemma~\ref{lem:q-interval} satisfies
$E = O(\varepsilon_{\mathrm{mach}}^2\,\|M\|^2
  / |\lambda_{\min}|)$
(Remark~\ref{rem:interval-width}),
...
Section~\ref{app:kkt} provides a fallback:
