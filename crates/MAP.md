...
| `crates/euclidean-polytopes/` | ordinary convex-polytope geometry in ambient `R^4`; currently owns exact origin-interior, exact extreme-point, exact polar vertex enumeration, diagnostic `f64` polar enumeration, and full-dimensional `f64` volume from recovered or known incidence | `crates/euclidean-polytopes/README.md`, `crates/euclidean-polytopes/DEVELOPMENT.md`, `tasks/euclidean-polytopes.md` |
