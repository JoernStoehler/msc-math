...
polygons, \(c_{\mathrm{EHZ}}(K)\) is obtained by minimizing over the
Haim--Kislev quadratic programs associated to cyclic words of the form
\[
...
find a finite subfamily that contains at least one capacity-realizing word for
a Lagrangian product.
...
corresponding Haim--Kislev quadratic program. The capacity is the minimum action
among the feasible words in this candidate family.
\end{algorithm}
