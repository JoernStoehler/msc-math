...
Load `references/ai-failure-modes.md` (which points to `.agents/skills/paperorchestra-shared/ai_failure_modes.md`).
...
```bash
python .agents/skills/paperorchestra-content-refinement-agent/scripts/snapshot.py \
...
```bash
python .agents/skills/paperorchestra-content-refinement-agent/scripts/update_critique_memory.py \
...
```bash
python .agents/skills/paperorchestra-content-refinement-agent/scripts/concession_guard.py \
...
in with `python .agents/skills/paperorchestra-content-refinement-agent/scripts/decision_band.py
...
```bash
python .agents/skills/paperorchestra-content-refinement-agent/scripts/score_delta.py \
...
- `.agents/skills/paperorchestra-shared/writing_quality_check.md` — full anti-AI-prose checklist (5 categories)
- `.agents/skills/paperorchestra-shared/ai_failure_modes.md` — full AI research failure modes gate (7 modes)
- `.agents/skills/paperorchestra-shared/handoff_schemas.md` — formal data contracts between all pipeline steps
- `.agents/skills/paperorchestra-shared/research_brief_template.md` — **NEW** research brief schema (read §1–§4 before first reviewer call)
