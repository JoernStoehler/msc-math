...
%
% Status: ASPIRATIONAL (verification.rs needs rewrite), APPROVED (Jörn 2026-02-16)
%
% Sources: crates/datasets/src/bin/verification.rs (verification binary),
%   experiments/data/verification.jsonl (generated dataset).
%
