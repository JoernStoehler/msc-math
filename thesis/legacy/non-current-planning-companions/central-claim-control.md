...
| `00-abstract.tex` | The rotated regular-pentagon product has the exact named `sys > 1` profile. | `09-rotated-regular-polygons*.tex`; `thesis/legacy/non-current-planning-companions/rotated-regular-polygons-content.md`; `experiments/regular-products/README.md`; `experiments/regular-products/pentagon-rotation-formula-proof/README.md`; endpoint/symmetry sources. | Do not generalize beyond the checked pentagon-product family or classify all minimizers. |
