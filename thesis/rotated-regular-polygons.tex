...
This section contains the current theorem-facing integration of the executable
certificate. The open-domain SageMath certificate has been rerun after the
readability cleanup and passes. Before this result is used as final thesis
source truth, the finite-candidate reduction and the endpoint, symmetry, and
continuity closure paragraphs still need final mathematical review.
\end{remark}
...
% The finite-candidate theorem is now present in active thesis prose, but the
% compact import from the legacy/formal source still needs final mathematical
% review before the pentagon result is final source truth.
...
% Same review dependency as above: this specialization depends on the compact
% finite-enumeration theorem in the HK2019 section.
...
\[
  \texttt{CERTIFICATE PASSED in 2010.05s}.
\]
