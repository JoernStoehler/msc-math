...
minimal GPT-5.5 run.  With one run per cell, no randomization, and no exact
prompt record, this does not establish a model or prompting effect.  It does
show concretely why fail-before/pass-after mutation evidence is stronger than
an ordinary passing suite.
