...
\item \textbf{$(4,4)$ at $\theta = 45^\circ$}: Two squares with relative
  ...
  % [TODO: JÖRN - this polytope might be the cross-polytope B^4 or
  %  a symplectic image of it. Worth checking if it's a known Viterbo
  %  saturator from the literature.]
...
\item \textbf{$(3,6)$ at $\theta = 0^\circ$}: Triangle $\times_L$ hexagon
  ...
  % [TODO: JÖRN - is this a known Viterbo-saturating body? The dual
  %  relationship between triangle and hexagon (hexagon = 2x dilated
  %  dual of triangle) may explain the saturation.]
...
\item \textbf{Viterbo saturation at $(3,6)$ and $(4,4)$.}
  ...
  with~$c = 2\sqrt{2}$ and~$\operatorname{vol} = 4$; this may correspond
  to a known Viterbo-saturating body (e.g., the cross-polytope~$B^4$).
  For~$(3,6)$ at~$0^\circ$, the triangle--hexagon duality (the regular
  hexagon tiles by six copies of the equilateral triangle) may underlie
  the saturation.
\end{enumerate}
