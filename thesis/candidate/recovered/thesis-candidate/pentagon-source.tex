...
Section~\ref{sec:rotated-regular-polygons} reduces the rotation theorem to exact
finite predicates. This appendix makes the correspondence between those
predicates and the Sage source directly inspectable.  The excerpts are copied
in cleaned form from the executable identified in that section: diagnostics, return-value
