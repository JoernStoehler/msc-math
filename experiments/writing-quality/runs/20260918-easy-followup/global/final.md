...
The first such experiment generated 100,000 product candidates and applied geometric selection rules. Capacity was evaluated on the union of selected bodies and controls, comprising 1,675 distinct candidates. The largest stored target was approximately $0.867546$, with none above one. The experiment screened a much larger pool than it evaluated, but its maximum alone does not measure whether selection improved on random choice. The following experiments compare specified selectors against alternatives.
