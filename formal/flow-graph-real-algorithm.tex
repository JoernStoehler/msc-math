...
Rust correspondence for the action-cutoff optimization, arbitrary
bounded-irredundant input validation, broader Rust correspondence, and f64
analysis are separate implementation and numerical-analysis obligations.
\end{remark}
