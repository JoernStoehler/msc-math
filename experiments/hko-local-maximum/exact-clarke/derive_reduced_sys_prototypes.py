...
Input Artifacts: experiments/hko-local-maximum/exact-clarke/segment-a-gradient-reduction.json
                 experiments/hko-local-maximum/exact-clarke/hko-volume-derivative.json
Output Artifacts: experiments/hko-local-maximum/exact-clarke/reduced-sys-prototypes.json
"""
