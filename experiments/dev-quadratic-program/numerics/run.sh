...
if [[ $# -lt 2 ]]; then
  experiments/dev-quadratic-program/verification/run.sh "$VERIFY_DIR"
...
python3 experiments/dev-quadratic-program/numerics-audit/scripts/summarize_observations.py "$OUT_DIR"
