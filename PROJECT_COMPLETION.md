...
| C3d | Jörn wording, later | Should “candidate-proposer for finding `sys > 1`” be reserved for threshold-directed methods, while the finite ridge/rho filters are called operational sub-threshold proposers? | choose terminology without changing the exploration verdict | FACTSHEET 34.2 and final data-science wording |
