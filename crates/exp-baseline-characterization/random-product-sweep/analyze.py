...
Input: crates/exp-baseline-characterization/random-product-sweep/random-product-sweep.jsonl
Output: crates/exp-baseline-characterization/random-product-sweep/random_product_sweep_sys_vs_pair.png
"""
