---
name: paperorchestra-plotting-agent
...
4. **Render**:
   ...
   **If `PAPERBANANA_PATH` is set** — use the PaperBanana backbone
   ...
   ```bash
   python .agents/skills/paperorchestra-plotting-agent/scripts/paperbanana_render.py \
       --figure-id <figure_id> \
...
```bash
python .agents/skills/paperorchestra-plotting-agent/scripts/render_diagram.py \
