\section{A Rational-Arithmetic Flow-Graph Algorithm}
...
We first prove correctness for a rational-arithmetic search under
...
\begin{theorem}[Rational flow-graph correctness]
...
normalized irredundant facet presentation.  Then the exhaustive
rational-arithmetic
...
The implementation represents the normals and all tube arithmetic by
