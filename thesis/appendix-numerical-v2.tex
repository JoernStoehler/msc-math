...
\item \emph{Singular vectors.}
  ...
  $\theta(\hat v_j, v_j)
    \lesssim \varepsilon_{\mathrm{mach}}\,\|M\|\, / \,
    \operatorname{gap}_j$,
  ...
  individual vectors, but their joint span remains accurate.
\item \emph{Solve step.}
  The back-substitution
  $\hat x = \hat V \hat\Sigma^{-1} \hat U^\top b$ satisfies
  $\|\hat x - x\| / \|x\|
    \lesssim \kappa(M)\,\varepsilon_{\mathrm{mach}}$,
