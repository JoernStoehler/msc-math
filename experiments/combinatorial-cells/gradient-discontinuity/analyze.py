...
Input: experiments/combinatorial-cells/boundary-characterization/combinatorial-boundaries-gradient.jsonl
...
Output: experiments/combinatorial-cells/gradient-discontinuity/*.png
