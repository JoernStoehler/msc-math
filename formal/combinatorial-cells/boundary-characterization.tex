% formal/combinatorial-cells/boundary-characterization.tex — boundary-characterization experiment
%
...
%   - research/combinatorial-cells/design/boundary-characterization.md: empirical continuity observation
%   - formal/library/kkt.tex: transition feasibility [lem:numerical-transition-feasibility]
%   - formal/library/geom.tex: EHZ capacity [def:ehz-capacity], systolic ratio [def:systolic-ratio]
...
% [TODO: JÖRN - citation is \cite{HoferZehnder1994}, Ch. 2 (monotonicity axiom A1).
