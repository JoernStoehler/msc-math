...
Random polytopes have errors below~$10^{-9}$ for $F \le 9$; at
...
facet counts. The jump at $F = 10$ reflects the combinatorial growth
in orbit length (more facet transitions) and the resulting accumulation
...
special structure: the hypercube and both symplectic products have
$\dim = 2$ (two pairs of parallel active facets), while the Lagrangian
triangle--square product has $\dim = 1$. No random polytope exhibits
non-uniqueness, consistent with linearly dependent active normals
being a measure-zero condition.
