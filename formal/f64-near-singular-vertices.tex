...
% systems seen by experiments/dev-f64-capacity.
%
% Labels defined here:
...
\texttt{experiments/dev-f64-capacity}.  For a four-subset
...
\[
  \texttt{cargo run -p exp-dev-f64-capacity --release --bin f64-capacity-near-singular}
\]
