...
implementation.  This distinction was examined in a structured four-run case
study of a historical bug in the reduced gradient of a projection routine.
Four fresh agents received the same pre-fix code and reconstructed task
contracts for the same mathematical discrepancy, without being given the
historical fixture or answer.  The conditions crossed model generation
with a minimal or verifier-first contract.  The exact original prompt text is
not recoverable, so this design cannot identify a causal effect of either
factor.
...
Other selected difficult proof-development episodes had a different outcome.  An
