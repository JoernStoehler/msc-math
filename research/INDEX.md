...
| Hostile sys-search landscape | `experiments/sys-datascience/README.md`, `experiments/sys-datascience/methods/README.md`; legacy ascent/continuation context: `experiments/sys-landscape/legacy-ascent-continuation-debt.md` | datascience README files and method packets own current state |
