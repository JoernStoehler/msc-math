...
%
% Notation:
%   Exact quantities:  beta^*, Q^*  (superscript *)
%   Computed (f64):    \tilde\beta, \tilde Q  (tilde)
%   Perturbation:      \delta\beta = \tilde\beta - \beta^*  (delta)
%   H, C, d — per-sigma QP matrices
%   A = {C beta = d}, F = A cap {beta >= 0}
%   H' = V^T H V — reduced Hessian on ker(C)
%   g = V^T H beta_0 — gradient at beta_0
