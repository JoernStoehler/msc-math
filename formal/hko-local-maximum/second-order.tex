% formal/hko-local-maximum/second-order.tex — input by formal/main.tex
%
% Second-order sufficient conditions for local maximality of the systolic ratio.
%
% Sources:
%   - Generated data: experiments/hko-local-maximum/second-order/second-order-base.jsonl
%   - Gradient analysis: formal/hko-local-maximum/gradient-analysis.tex
%   - Capacity derivatives: formal/library/algorithms.tex [lem:cap-derivative]
%   - Volume derivatives: formal/library/algorithms.tex [lem:vol-derivative]
