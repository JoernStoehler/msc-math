...
%
% [TODO: JÖRN - verify or correct. The Type A filtering is empirically
%  justified (0 Type C across ~4300 perms on 6 polytopes) but lacks a
%  proof that Type C cannot occur.]
