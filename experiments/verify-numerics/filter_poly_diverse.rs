//! Stage 2 filter: diverse sample from collected_poly.jsonl.
//!
...
//!
//! Usage:
//!   cargo run --release --bin filter_poly_diverse
//!
//! Input:  verify-numerics/collected_poly.jsonl
//! Output: verify-numerics/filtered_poly_diverse.jsonl
...
const OUTPUT_PATH: &str = "verify-numerics/filtered_poly_diverse.jsonl";
