...
- **Empirical performance** (from research/numerics/design/error-bounds.md, 44,808 natural polytope σ-nodes):
...
### Empirical validation summary (from research/numerics/design/error-bounds.md)
