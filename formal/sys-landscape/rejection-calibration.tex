% formal/sys-landscape/rejection-calibration.tex — input by formal/main.tex
%
...
%   - Empirical acceptance rates: research/sys-landscape/design/rejection-calibration.md (moved from here)
%
% Structure:
