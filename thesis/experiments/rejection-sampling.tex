...
%     positive span). Proof written by Claude, verified by Jörn.
%   - Acceptance rate data: real code execution (validation.rs), stub
%     volume/capacity. See \color{red} note at end of file.
%
% Structure:
...
%
% QC: The proposition and proof were reviewed by a QC agent (6 findings,
% all resolved). Jörn verified structure and text up to "Acceptance rate
% sweep." The inline % QC comments document sign-symmetry and ker(A)
% justifications that a pedantic reader might want spelled out.
