...
INPUT_FILENAME = "sage-validation-input.jsonl"
SMOKE_INPUT_FILENAME = "smoke-sage-validation-input.jsonl"
OUTPUT_FILENAME = "sage-validation-report.jsonl"
SMOKE_OUTPUT_FILENAME = "smoke-sage-validation-report.jsonl"
