...
"""
Ablation study analysis: compare HK2017 transition-pruning variants (A-axis).

A0 (unpruned) → A1 (facet intersection) → A2 (directed ω₀) → A3 (Reeb-flow feasibility).
Each variant adds strictly more pruning than the previous.

Input Artifacts: experiments/verification/algorithm-comparison/ablation/ablation.jsonl (generated by ablation.rs)
Output Artifacts: experiments/verification/algorithm-comparison/ablation/ablation_timing.png (timing comparison figure)
"""
...
VARIANTS = ["a0_unpruned", "a1_facet_intersection", "a2_omega_directed", "a3_reeb_feasible"]
VARIANT_LABELS = {
    "a0_unpruned": "A0 unpruned",
    "a1_facet_intersection": "A1 facet intersection",
    "a2_omega_directed": "A2 directed ω₀",
    "a3_reeb_feasible": "A3 Reeb feasible",
}
LEGACY_VARIANT_ALIASES = {
    "a1_vertex_adj": "a1_facet_intersection",
}
    ...
    with open(DATA_PATH) as f:
        for line in f:
            ...
            if line:
                ...
                entry["variant"] = LEGACY_VARIANT_ALIASES.get(entry["variant"], entry["variant"])
...
def print_timing_table(entries):
    ...
    for group, f in group_f_pairs:
        ...
        m1 = means.get("a1_facet_intersection")
...
def plot_timing(entries):
    ...
    colors = {
        "a0_unpruned": "#e08020",
        "a1_facet_intersection": "#2060c0",
        "a2_omega_directed": "#20a040",
        "a3_reeb_feasible": "#a02080",
    }
    markers = {
        "a0_unpruned": "^",
        "a1_facet_intersection": "o",
        "a2_omega_directed": "s",
        "a3_reeb_feasible": "D",
    }
    ...
    fig.suptitle(
        "Transition pruning: timing by facet count (mean $\\pm$ std, $n=5$)",
    )
