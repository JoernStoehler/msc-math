...
- [legacy-era 2026-04-25, moved 2026-05-18]
  `thesis/legacy/migration-findings.md` is an old thesis/code mismatch
  inventory. Rows 3-11 may affect algorithm/numerics exposition, rows 1 and
  12-14 may affect tube/code-vs-thesis alignment, row 2 is a
