...
Do the symplectic areas of a four-dimensional polytope's two-dimensional
faces help explain the size of its systolic ratio? Such a relationship
could also help identify promising bodies before evaluating capacity. An association across a broad collection of
...
is evaluated. From a fresh pool of 100,000 Lagrangian products, selecting
the ten lowest-$R$ bodies in each factor-side-count group gave mean ratio $0.626$,
compared with $0.316$ for ten comparison bodies per group. The comparison
...
maps. In a separate fresh pool of 100,000 products, among those in the
lowest one percent by $R$, the half with lower $C$ had a mean advantage of $0.034$ over the other
...
is confined to comparisons of unrelated bodies. We compared sixteen
Lagrangian products with changed versions, eight in the $4\times4$ group
and eight in the $4\times6$ group. Keeping polygon normals
...
branches from earlier points attained the largest median best-so-far
numerical ratios:
\begin{center}
\begin{tabular}{lrr}
\hline
