# AI-Use Disclosure Content Notes

Status: content companion for the unnumbered front-matter disclosure in
...
The disclosure must let a reader answer:

1. Was generative AI used, through which principal systems, and was it
...
6. Given overlapping contributions, what should named authorship and the
   ...
   submitted work?
7. How granularly can credit or first origin for ideas, prose, code, and
   decisions be assigned honestly?

The main reader interests behind these questions are:
...
- **provenance and credit:** what work agents performed, what Jörn performed,
  and where a clean allocation is not supportable.

## Intended knowledge transfer

After reading the page, the reader should understand:

- AI agents were material participants across research and production, not
  merely proofreading or code-transcription tools.
- Agents sometimes helped formulate what to do and how to judge it; they also
  produced, interpreted, criticized, revised, delegated, and reviewed work.
- Jörn participated in these same kinds of activities, but no category of work
  he performed was categorically reserved to him: every kind of thesis labor he
...
- Jörn's named authorship must not be interpreted as asserting sole production,
  sole intellectual origin, or line-by-line human authorship. The disclosure
  need not add a stronger positive theory of authorship.
- Kai orally approved the breadth of AI use described on the page.

## Sources

- `experiments/ai-use/reports/ai-provenance-log-backed-summary.md`: aggregate
  interaction-provenance support for labor categories and Jörn's documented
  steering, correction, rejection, and selected approvals.
- `experiments/ai-use/README.md`: methodology, privacy boundary, and limits on
  claims about origin, acceptance, and correctness.
- Jörn clarification, 2026-07-13: he cannot identify any form of labor he
  performed on the thesis that he did not at some point outsource to agents.
- Jörn confirmation, 2026-07-13: Kai explicitly approved AI use at the breadth
  described here, including research direction, mathematical reasoning,
  software, experiments, interpretation, review, and thesis prose. Kai gave
...
- It may state Kai's oral approval of the breadth of AI use, but must not infer
  broader advisor endorsement of retained claims.
