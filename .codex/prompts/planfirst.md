...
message in chat instead of a plan. Include enough context to answer cheaply, use
progressive disclosure, state useful defaults or uncertainty when helpful, and
avoid long unskippable background.

Otherwise, send a polished plan in chat. Do not paste scratch notes or narrate
the investigation. The plan should be actionable, compare materially different
