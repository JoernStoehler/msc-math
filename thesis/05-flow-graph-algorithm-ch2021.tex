...
symplectic flow graph of Chaidez--Hutchings \cite{CH2021}: facet-pair sections
are used as sections, Reeb passages through facets give
affine maps between sections, and a closed trajectory is a fixed point of a
composed return map.  The correctness proof here is different from the
