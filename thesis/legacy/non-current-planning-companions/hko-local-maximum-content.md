...
2. Main theorem target:
   ...
   `thesis/legacy/non-current-planning-companions/central-claim-control.md`;
   `thesis/07-hko-local-maximum.tex`.
...
- remaining: later integrated-PDF review may request wording or proof-framing
  changes.
...
- `experiments/hko-local-maximum/README.md` for current status, folder roles,
  and ordinary integrated-PDF review risk.
...
Final-review risk:
- Later integrated-PDF review may request theorem-wording changes.
...
Final-review risk:
- Later integrated-PDF review may request changes to theorem wording or to the
  thesis presentation of the certificate.
...
- `experiments/sys-datascience/methods/README.md`.
- `experiments/sys-landscape/legacy-ascent-continuation-debt.md`.
- `thesis/legacy/non-current-planning-companions/central-claim-control.md`, HKO and
...
2. Refresh this thesis companion after integrated-PDF review if the HKO wording
   or proof framing changes.
...
- Integrated-PDF feedback:
  may request changes to theorem-strength HKO wording or Sage-readable
  proof-by-computation framing before university submission.
