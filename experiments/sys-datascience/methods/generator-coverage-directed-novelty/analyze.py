...
def main() -> None:
    ...
    print(json.dumps({"schema": SCHEMA, "side_counts": [item["side_count"] for item in panel_metadata], "selection_cost_artifact": str(args.out_dir / "selection-cost-observation.json")}))
