...
%
% Sources:
%   - Generated data: crates/exp-sys-landscape/rotated-regular-products/lagrangian-products-5x5.jsonl
%     and crates/exp-sys-landscape/rotated-regular-products/lagrangian-products-<n>x<m>-6deg.jsonl
...
% [TODO: JÖRN - add cross-reference to the random-product-sample experiment once written up]
...
\begin{figure}[h]
\centering
\includegraphics{lagrangian_products_5x5.png}
...
\begin{figure}[h]
\centering
\includegraphics{lagrangian_products_7x7.png}
...
\begin{figure}[h]
\centering
\includegraphics{lagrangian_products_polygon_pairs.png}
