...
### F1. The central HKO certificate is described more than it is exhibited
...
**Why this matters:** The reader can understand the abstract implication “these rows would prove local maximality” while still being unable to inspect how the actual HKO body yields those rows. This is a gap in the manuscript's presentation of its central proof. It is not evidence that the underlying theorem or witness is wrong.
...
**Minimum repair outcome:** A reader can identify the actual base geometry and formulas, follow at least one representative feasible-section/derivative calculation, and find an unambiguously identified finite witness and verifier for the larger calculation. It is not necessary to print a 26-by-40 matrix or every source-code line. The mathematical correspondence cannot be replaced by repeated assurances that the correspondence belongs to the hand proof.

**Assessment:** High-confidence manuscript deficiency; consequential for central-proof inspectability. Whether Jörn accepts more of this in a stable computational supplement is a reader-interface judgment, not a truth judgment about the theorem.
...
| HKO, pp. 59–66 | Strong theorem statement; recognizable slice and upper-function proof | Concrete certificate-to-geometry exposition missing; no independent full certificate rerun or correspondence certification |
