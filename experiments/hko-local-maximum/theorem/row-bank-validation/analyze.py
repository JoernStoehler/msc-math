...
Input Artifacts: experiments/hko-local-maximum/theorem/row-bank-validation/row-bank-validation-input.jsonl
Output Artifacts: experiments/hko-local-maximum/theorem/row-bank-validation/row-bank-validation-report.jsonl
"""
