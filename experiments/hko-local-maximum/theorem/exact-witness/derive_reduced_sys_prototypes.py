...
Input Artifacts: experiments/hko-local-maximum/theorem/exact-witness/segment-a-gradient-reduction.json
                 experiments/hko-local-maximum/theorem/exact-witness/hko-volume-derivative.json
Output Artifacts: experiments/hko-local-maximum/theorem/exact-witness/reduced-sys-prototypes.json
"""
