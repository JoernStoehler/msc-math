...
% FIXME(hbox): 4.05pt — "\textup{(Artstein-Avidan \& Ostrover~\cite{...}; Rudolf~\cite{...}.)} For a Lagrangian product..." overflows; try putting \textup{...} on its own line or using \\ before "For a Lagrangian"
...
% FIXME(hbox): 3.28pt — "\textup{(Bezdek \& Bezdek~\cite{...}; Rudolf~\cite{...}.)} For convex polygons..." overflows; try putting \textup{...} attribution on its own line before "For convex polygons"
