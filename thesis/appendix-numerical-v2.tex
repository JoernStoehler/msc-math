...
\item \emph{Solve step.}
  ...
  giving overall relative error
  $\|\hat x - x\| / \|x\|
    = O(\kappa_\tau\,\varepsilon_{\mathrm{mach}})$,
  where
  $\kappa_\tau = |\lambda_{\max}|
    / \min_{|\lambda_j|>\tau} |\lambda_j|$
  \cite[Ch.~5]{Higham2002}.
  Near-singular systems ($\kappa_\tau \gg 1$) amplify
