...
Input: crates/exp-sys-landscape/random-product-sweep/random-product-sweep.jsonl
Output: crates/exp-sys-landscape/random-product-sweep/random_product_sweep_sys_vs_pair.png
"""
