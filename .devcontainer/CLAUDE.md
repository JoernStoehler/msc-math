...
.devcontainer/
  ...
  post-create.sh             # Runtime setup after container creation (npm, gh auth, Claude Code, TeX)
...
Worktree management moved to `.claude/hooks/worktree-{create,remove}.sh` (Claude Code hooks).
