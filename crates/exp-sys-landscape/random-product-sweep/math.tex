...
%
% Sources:
%   - Generated data: crates/exp-sys-landscape/random-product-sweep/random-product-sweep.jsonl
%   - Plot script: crates/exp-sys-landscape/random-product-sweep/analyze.py
%   - Experiment notes: crates/exp-sys-landscape/random-product-sweep/logbook.md
%
% Structure:
%   - Sampling setup
%   - Summary plot
