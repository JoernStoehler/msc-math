...
import json
from analyze import SOURCE, SOURCE_REPORT, SOURCE_SHA, SOURCE_REPORT_SHA, digest, jsonl, validate_source
...
manifest = {
    ...
    "source_report_path": str(SOURCE_REPORT), "source_report_sha256": digest(SOURCE_REPORT),
