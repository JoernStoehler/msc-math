...
numerically verified, with the second condition checked along $15$ basis
directions and $100$ random directions (all negative). This constitutes
strong numerical evidence that HKO2024 is a strict local maximum of
$\operatorname{sys}$ among $F = 10$ polytopes in $\mathbb{R}^4$.
